...
`;
function IconCardsItems({ button, issue, hours, skills, Img}) {
    return (
        <Container>
            <SubDiv>
                <DivLogo>
                <img style={{width:'80%',borderRadius:"50%", flexDirection: 'row' , height: 'Hug(80px)'}} src={Img} alt='' />
                </DivLogo>
                <CardButton>
                    <SubButton>
                        <LogoButton>
