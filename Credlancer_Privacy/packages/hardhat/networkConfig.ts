...
export type NetworkConfig = {
  ...
  requestContracts: {
    // https://github.com/RequestNetwork/requestNetwork/blob/master/packages/smart-contracts/src/lib/artifacts/ERC20FeeProxy/index.ts
    erc20FeeProxy?: string;
    // https://github.com/RequestNetwork/requestNetwork/blob/master/packages/smart-contracts/src/lib/artifacts/EthereumFeeProxy/index.ts
    ethereumFeeProxy?: string;
  };
};
...
const mumbai: NetworkConfig = {
  ...
  requestContracts: {
    erc20FeeProxy: "0x131eb294E3803F23dc2882AB795631A12D1d8929",
    ethereumFeeProxy: "0x131eb294E3803F23dc2882AB795631A12D1d8929",
  },
};
